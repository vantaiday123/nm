...
const string strMessageMagic = "NelsonMandela Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NelsonMandela", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1503671106, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        block.nVersion = 1;
        block.nTime    = 1503671106;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1340902 : 1340902;
        ...
        assert(block.hashMerkleRoot == uint256("0x509c6a3fbddddf3c5ffab867828d9988fddbcf624a55bea81edd60e575f3fc8f"));
...
unsigned char pchMessageStart[4] = { 0x5e, 0xac, 0xfb, 0xba };
